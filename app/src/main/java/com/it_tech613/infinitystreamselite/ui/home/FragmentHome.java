package com.it_tech613.infinitystreamselite.ui.home;
...
import com.it_tech613.infinitystreamselite.models.*;
import com.it_tech613.infinitystreamselite.ui.LiveExoPlayActivity;
import com.it_tech613.infinitystreamselite.ui.LiveIjkPlayActivity;
import com.it_tech613.infinitystreamselite.ui.LivePlayActivity;
import com.it_tech613.infinitystreamselite.ui.MainActivity;
import com.it_tech613.infinitystreamselite.ui.liveTv.PinDlg;
        ...
        category_recyclerview.setAdapter(new HomeListAdapter(requireContext(), (categoryPos, itemPos, epgChannel, movieModel, seriesModel) -> {
            switch (categoryPos){
                ...
                case 2:
                    ...
                    requireActivity().getSupportFragmentManager().beginTransaction()
                            .replace(R.id.container,((MainActivity)requireActivity()).fragmentList.get(((MainActivity)requireActivity()).fragmentList.size()-6))//FragmentSeasons
                            .addToBackStack(null).commit();
                    break;
            }
            return null;
