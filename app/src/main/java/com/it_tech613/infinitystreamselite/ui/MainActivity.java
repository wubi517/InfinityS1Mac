package com.it_tech613.infinitystreamselite.ui;
...
import com.it_tech613.infinitystreamselite.apps.Constants;
import com.it_tech613.infinitystreamselite.apps.MyApp;
import com.it_tech613.infinitystreamselite.models.FullModel;
import com.it_tech613.infinitystreamselite.ui.catchup.FragmentCatchupCategory;
import com.it_tech613.infinitystreamselite.ui.home.FragmentHome;

import com.it_tech613.infinitystreamselite.ui.liveTv.FragmentExoLiveTv;
import com.it_tech613.infinitystreamselite.ui.liveTv.FragmentIjkLiveTv;
import com.it_tech613.infinitystreamselite.ui.liveTv.FragmentLiveTv;
import androidx.fragment.app.Fragment;
import androidx.recyclerview.widget.LinearLayoutManager;
import com.it_tech613.infinitystreamselite.models.SideMenu;
import com.it_tech613.infinitystreamselite.ui.catchup.FragmentCatchupDetail;
import com.it_tech613.infinitystreamselite.ui.movies.FragmentAllMovie;
import com.it_tech613.infinitystreamselite.ui.movies.FragmentMovieDetail;
import com.it_tech613.infinitystreamselite.ui.movies.FragmentMovies;
import com.it_tech613.infinitystreamselite.ui.multi.FragmentMultiScreen;
import com.it_tech613.infinitystreamselite.ui.multi.PinMultiScreenDlg;
import com.it_tech613.infinitystreamselite.ui.series.FragmentEpisodes;
import com.it_tech613.infinitystreamselite.ui.series.FragmentSeries;
import com.it_tech613.infinitystreamselite.ui.series.FragmentSeriesHolder;
import com.it_tech613.infinitystreamselite.ui.settings.FragmentSettings;
import com.it_tech613.infinitystreamselite.ui.tvGuide.FragmentTvGuide;
import com.it_tech613.infinitystreamselite.ui.series.FragmentSeasons;
import com.it_tech613.infinitystreamselite.utils.MyFragment;
import com.it_tech613.infinitystreamselite.vpn.fastconnect.core.OpenConnectManagementThread;
import com.it_tech613.infinitystreamselite.vpn.fastconnect.core.OpenVpnService;
import com.it_tech613.infinitystreamselite.vpn.fastconnect.core.VPNConnector;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        fragmentList.add(new FragmentSeriesHolder());
        ...
        menu_recyclerview.setAdapter(new MenuAdapter(list, this, (sideMenu, position) -> {
            if (sideMenu.getName().equals("Multi TV")){
                ...
                if(fullModel!=null && (fullModel.getChannels()==null ||fullModel.getChannels().size()==0)){
                    Toast.makeText(this,"No Live Channels!",Toast.LENGTH_LONG).show();
                    return null;
                }
                showScreenModeList();
                ...
                FullModel fullModel = Constants.getAllFullModel(MyApp.fullModels);
                if((sideMenu.getName().equals("Live Tv") || sideMenu.getName().equals("Tv Guide") || sideMenu.getName().equals("Catchup")) &&
                        fullModel!=null &&
                        (fullModel.getChannels()==null ||fullModel.getChannels().size()==0)){
                    Toast.makeText(this,"No Live Channels!",Toast.LENGTH_LONG).show();
                    return null;
                }else if (sideMenu.getName().equals("Movies") && (MyApp.movieModels==null || MyApp.movieModels.size()==0)){
                    Toast.makeText(this,"No Movies!",Toast.LENGTH_LONG).show();
                    return null;
                }else if (sideMenu.getName().equals("Series") && (MyApp.seriesModels==null || MyApp.seriesModels.size()==0)){
