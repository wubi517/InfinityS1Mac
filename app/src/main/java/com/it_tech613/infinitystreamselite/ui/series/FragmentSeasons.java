...
import com.it_tech613.infinitystreamselite.models.EpisodeInfoModel;
import com.it_tech613.infinitystreamselite.models.EpisodeModel;
import com.it_tech613.infinitystreamselite.models.SeasonModel;
            ...
            categoryRecyclerView.setAdapter(new SeriesListAdapter(MyApp.selectedSeriesModelList, (model, position) -> {
                ...
                if (seriesModel.getSeasonModels()==null || seriesModel.getSeasonModels().size()==0) {
                    ...
                    bookSubscription = booksObservable.
                            ...
                            subscribe(seasonModels -> requireActivity().runOnUiThread(()->{
    ...
    public boolean myOnKeyDown(KeyEvent event){
        ...
        switch (event.getKeyCode()){
            case KeyEvent.KEYCODE_DPAD_RIGHT:
                if (view != null && view.getId()==R.id.video_list_recyclerview)
                    addFav.requestFocus();
                break;
        }
