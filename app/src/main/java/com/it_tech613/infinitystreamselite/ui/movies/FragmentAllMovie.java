package com.it_tech613.infinitystreamselite.ui.movies;
...
import com.it_tech613.infinitystreamselite.models.MovieInfoModel;
import com.it_tech613.infinitystreamselite.models.MovieModel;
import com.it_tech613.infinitystreamselite.ui.TrailerActivity;
import com.it_tech613.infinitystreamselite.ui.VideoExoPlayActivity;
import com.it_tech613.infinitystreamselite.ui.VideoIjkPlayActivity;
import com.it_tech613.infinitystreamselite.ui.VideoPlayActivity;
...
public class FragmentAllMovie extends MyFragment implements View.OnClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        watchTrailer = view.findViewById(R.id.button2);
        watchMovie = view.findViewById(R.id.button3);
    ...
    private void addToFav() {
        if (showMovieModel.isIs_favorite()) {
            ...
            fav_movie_names.addAll(Constants.getFavoriteCatetory(MyApp.vod_categories).getMovieModels());
            //set
